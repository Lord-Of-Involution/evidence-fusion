...
def main(args):
    ...
    gnn = EvidenceGNN(r_link=args.r_link, hidden_dim=64).to(device)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mlp_dir", type=str, default="/work/hdd/bdne/jdong8/fusion_models/mlp_400")
    ...
    parser.add_argument("--r_link", type=float, default=20.0, help="Must match training setup!")
